...
#define ab8(y) ar wa = 90; AB(8,80,0,0,0,0,30,y); cw
...
CPsd(12,8,10,5,14,0,40,50);
CPsd(10,8,10,5,14,0,40,0);
CPsd(-0,8,1000,5,14,40,40,0);
Axis(0,8,0,40,-50);

Ot(26,90,90,40,50);
Ot(26,90,90,40,-50);

CPsd(12,1,10,5,14,0,40,50);
CPsd(10,1,11,5,14,0,40,0);

Ot(26,-90,-90,40,150);

CPsd(12,8,10,5,14,0,40,50);
CPsd(10,8,10,5,14,0,40,0);
CPsd(-0,8,1000,5,14,45,40,0);
Axis(0,8,0,40,-50);
